          ...
          {products.map((product: Product, index: number) => (
            <div key={index} className="group relative" style={{ flex: 1 }}>
              ...
              <div className="mb-2 flex items-center justify-between" style={{ fontSize: "10px", color: "#000000" }}>
                <span>
                  <strong>Alk. →</strong> {product.alcohol}% obj.
                </span>
              ...
              <div className="flex items-center gap-2">
                {product.salePrice ? (
                  <>
                    <span style={{ color: "#FF4C4C", fontWeight: 700 }}>{product.salePrice}</span>
                    <span className="line-through" style={{ fontSize: "10px", color: "#666" }}>
                      {product.price}
                    </span>
                  </>
                ) : (
                  <span style={{ color: "#212121", fontWeight: 700 }}>{product.price}</span>
                )}
