...
const ZichovecLogo = () => (
  <svg width="1258" height="143" viewBox="0 0 1258 143" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full max-w-md h-auto">
...
export const ZichovecHeaderWithMenuBlock = ({ block, onUpdate }: ZichovecHeaderWithMenuBlockProps) => {
  ...
  return (
    <div 
      ...
      style={{ backgroundColor: '#00C322', minHeight: '200px' }}
    >
      <div className="w-full max-w-md mb-8 px-8">
        <ZichovecLogo />
      </div>
