...
const ZichovecLogo = () => (
  <svg width="1258" height="143" viewBox="0 0 1258 143" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '363px', height: 'auto' }}>
...
export const ZichovecHeaderWithMenuBlock = ({ block, onUpdate }: ZichovecHeaderWithMenuBlockProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap justify-center pb-6" style={{ gap: '8px' }}>
